...
<form action="<%=request.getContextPath() %>/login2.jsp" method="post">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Username" name="id" value="<%=id%>" required>
    ...
    <label>
      <input type="checkbox" <%if(id.length() >0) {out.print("checked");} %> name=check1> Remember id
    </label>
  </div>
